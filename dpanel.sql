...
(8, 'WELCOME TO OUR SCHOOL', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam accumsan dolor id enim lacinia, sed feugiat ex suscipit. Nunc molestie malesuada pellentesque', 'x', 'Arial', '25/01/2019', '2018-12-25', '2019-01-31', '09:59:15pm', 1, 'nitin'),
...
(1, '', 'Doon Convent School', '9760020667', 'doon@gmail.com', 'Bareilly Road, Gaujajali (Uttar)', 'Haldwani', 'Nainital', 'Uttarakhand', 'INDIA', 'CBSE', 'www.doonconventschool.edu.in', 'Good', '2019-06-23 19:15:32', 'nitin');
...
CREATE TABLE `tc_detail` (
  ...
  `RENEWED_UPTO` varchar(50) NOT NULL,
  `SCHOOL_STATUS` varchar(50) NOT NULL COMMENT 'Secondary or Sr. Secondary',
  `REGNO_OF_CANDIDATE` varchar(20) NOT NULL DEFAULT 'NA',
  `CANDIDATE_NAME` varchar(100) NOT NULL,
  `CANDIDATE_ADHAAR` varchar(20) NOT NULL,
  `MOTHERS_NAME` varchar(100) NOT NULL,
  `MOTHER_ADHAAR` varchar(20) NOT NULL,
  `FATHERS_NAME` varchar(100) NOT NULL,
  `FATHER_ADHAAR` varchar(20) NOT NULL,
  `NATIONALITY` varchar(15) NOT NULL DEFAULT 'NA',
  `DOB_IN_FIGURES` varchar(50) NOT NULL,
...
--
-- Dumping data for table `tc_detail`
--

INSERT INTO `tc_detail` (`TCID`, `SCHOOL_NO`, `BOOK_NO`, `SNO`, `ADMISSION_NO`, `AFFILIATION_NO`, `RENEWED_UPTO`, `SCHOOL_STATUS`, `REGNO_OF_CANDIDATE`, `CANDIDATE_NAME`, `CANDIDATE_ADHAAR`, `MOTHERS_NAME`, `MOTHER_ADHAAR`, `FATHERS_NAME`, `FATHER_ADHAAR`, `NATIONALITY`, `DOB_IN_FIGURES`, `DOB_IN_WORDS`, `SC_ST_OBC_GEN_CATEGORY`, `STUDENT_FAILED`, `SUBJECT_OFFERED`, `LAST_STUDIED_CLASS`, `SCHOOL_OR_BOARD`, `PROMOTED`, `DUES_PAID`, `ANY_CONSESSION`, `NCC_SCOUT_GUIDE`, `DATE_OF_CUTTING_NAME`, `REASON_OF_LEAVING_SCHOOL`, `NO_OF_MEETING_UPTODATE`, `SCHOOL_DAYS_ATTENDED`, `GENERAL_CONDUCT_OF_STUDENT`, `REMARKS_IF_ANY`, `DATE_OF_ISSUE`, `USERNAME`, `DATE_`, `STATUS`, `SESSION_`, `CLASS_`, `ORIGINAL`, `TERMS`, `TCNO`) VALUES
(6, '123', '345', '1', '12', '1234', '23/3/2125', 'active', '12345', 'Nitin', '', 'Sunita', '', 'Virendra', '', 'indian', '', '12/2/1999', 'GEN', 'no', 'computer', '7', 'CBSE', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-14', 'nitin', '2019-11-14 15:25:25', 1, '2019', '8', 1, '', 110),
(8, '123', '345', '4', '15', '1234', '23/3/2125', 'active', '12345', 'Farhan', '', 'Sunita', '', 'Virendra', '', 'indian', '', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-17', 'nitin', '2019-11-17 03:34:32', 1, '2019', '9', 2, '', 111),
(9, '123', '345', '3', '14', '1234', '23/3/2125', 'active', '12345', 'Nitika', '44893669866322', 'Sunita', '123456789152', 'Virendra', '321456987456', 'indian', '', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-16', 'nitin', '2019-11-16 16:57:17', 1, '2019', '9', 1, '', 112),
(11, '123', '345', '2', '13', '1234', '23/3/2125', 'active', '12345', 'ANKUR SINGH', '', 'Sunita', '', 'Virendra', '', 'indian', '', '12/2/1999', 'GEN', 'no', 'computer', '7', 'CBSE', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-16', 'nitin', '2019-11-16 17:00:19', 1, '2019', '8', 2, '', 109),
(12, '123', '567', '45', '16', '23', '30/12/2019', '1', '123654', 'HARVINDARA', '65478963952', 'SMT HARMIT', '258741369874', 'HARMITA SINGH', '254369874123', 'INDIAN', '', '12', 'SC', 'NO', 'X, Y, Z', 'X', 'CBSE', 'YES', 'YES', 'NO', 'NCC', '12/2/2018', 'SWITCHING', '253', '501', 'GOOD', 'NO', '2019-11-16', 'nitin', '2019-11-16 17:10:18', 1, '2019', '11', 1, '', 113);

-- --------------------------------------------------------

--
-- Table structure for table `tc_detail_cancelled`
--

CREATE TABLE `tc_detail_cancelled` (
  `TCID` int(11) NOT NULL,
  `SCHOOL_NO` varchar(11) NOT NULL DEFAULT 'NA',
  `BOOK_NO` varchar(11) NOT NULL DEFAULT 'NA',
  `SNO` varchar(25) NOT NULL DEFAULT 'NA',
  ...
  `TERMS` text NOT NULL,
  `TCNO` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='store cancelled TCs';

--
-- Dumping data for table `tc_detail_cancelled`
--

INSERT INTO `tc_detail_cancelled` (`TCID`, `SCHOOL_NO`, `BOOK_NO`, `SNO`, `ADMISSION_NO`, `AFFILIATION_NO`, `RENEWED_UPTO`, `SCHOOL_STATUS`, `REGNO_OF_CANDIDATE`, `CANDIDATE_NAME`, `MOTHERS_NAME`, `FATHERS_NAME`, `NATIONALITY`, `DOB_IN_WORDS`, `SC_ST_OBC_GEN_CATEGORY`, `STUDENT_FAILED`, `SUBJECT_OFFERED`, `LAST_STUDIED_CLASS`, `SCHOOL_OR_BOARD`, `PROMOTED`, `DUES_PAID`, `ANY_CONSESSION`, `NCC_SCOUT_GUIDE`, `DATE_OF_CUTTING_NAME`, `REASON_OF_LEAVING_SCHOOL`, `NO_OF_MEETING_UPTODATE`, `SCHOOL_DAYS_ATTENDED`, `GENERAL_CONDUCT_OF_STUDENT`, `REMARKS_IF_ANY`, `DATE_OF_ISSUE`, `USERNAME`, `DATE_`, `STATUS`, `SESSION_`, `CLASS_`, `ORIGINAL`, `TERMS`, `TCNO`) VALUES
(1, '123', '345', '1', '12', '1234', '23/3/2125', 'active', '12345', 'Nitin', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 02:13:37', 1, '2019', '8th', 1, '', 102),
(4, '123', '345', '4', '15', '1234', '23/3/2125', 'active', '12345', 'Farhan', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 02:14:14', 1, '2019', '9', 3, '', 103),
(5, '123', '345', '1', '12', '1234', '23/3/2125', 'active', '12345', 'Nitin', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 02:19:25', 1, '2019', '8th', 2, '', 104),
(5, '123', '345', '1', '12', '1234', '23/3/2125', 'active', '12345', 'Nitin', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 03:18:34', 1, '2019', '8th', 2, '', 104),
(5, '123', '345', '1', '12', '1234', '23/3/2125', 'active', '12345', 'Nitin', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 03:18:34', 1, '2019', '8th', 1, '', 104),
(2, '123', '345', '2', '13', '1234', '23/3/2125', 'active', '12345', 'Ankur', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 02:13:17', 1, '2019', '8', 1, '', 101),
(4, '123', '345', '4', '15', '1234', '23/3/2125', 'active', '12345', 'Farhan', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 02:14:14', 1, '2019', '9', 2, '', 103),
(4, '123', '345', '4', '15', '1234', '23/3/2125', 'active', '12345', 'Farhan', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 02:14:14', 1, '2019', '9', 1, '', 103),
(3, '123', '345', '3', '14', '1234', '23/3/2125', 'active', '12345', 'Nitika', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 03:18:46', 1, '2019', '9', 1, '', 105),
(7, '123', '345', '2', '13', '1234', '23/3/2125', 'active', '12345', 'ANKUR SINGH', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 13:42:30', 1, '2019', '8', 3, '', 107),
(7, '123', '345', '2', '13', '1234', '23/3/2125', 'active', '12345', 'ANKUR SINGH', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 13:42:30', 1, '2019', '8', 2, '', 107),
(7, '123', '345', '2', '13', '1234', '23/3/2125', 'active', '12345', 'ANKUR SINGH', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'cbse', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 13:42:30', 1, '2019', '8', 1, '', 107),
(10, '123', '345', '2', '13', '1234', '23/3/2125', 'active', '12345', 'ANKUR SINGH', 'Sunita', 'Virendra', 'indian', '12/2/1999', 'GEN', 'no', 'computer', '7', 'CBSE', 'yes', 'yes', 'no', 'ncc', '20/07/2019', 'switching', '520', '620', 'good', 'good', '2019-11-03', 'nitin', '2019-11-03 13:45:53', 1, '2019', '8', 1, '', 108);
...
INSERT INTO `tc_issued` (`ISTID`, `TCID`, `DATE_OF_ISSUE`, `TERMS`, `REMARKS`, `USERNAME`, `DATE_`, `STATUS`) VALUES
(1, 2, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 03:22:17', 'CANCELLED'),
(2, 1, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 02:14:30', 'CANCELLED'),
(3, 4, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 03:22:40', 'CANCELLED'),
(4, 4, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 03:22:35', 'CANCELLED'),
(5, 4, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 02:14:52', 'CANCELLED'),
(6, 5, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 03:19:09', 'CANCELLED'),
(7, 5, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 03:15:32', 'CANCELLED'),
(8, 5, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 03:19:00', 'CANCELLED'),
(9, 3, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 03:22:47', 'CANCELLED'),
(10, 0, '2019-11-03', 'I (nitin) accept all terms &amp; Conditions in issuing this Transfer Certificate as (<span class="copy__">...</span> copy) on date: <span class="dt_">03-11-2019</span> on behalf of the School (<span>School Name, City</span>) authority.', 'no remark', 'nitin', '2019-11-03 06:37:11', 'ISSUED'),
(11, 7, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 13:45:27', 'CANCELLED'),
(12, 7, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 13:45:19', 'CANCELLED'),
(13, 7, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 13:45:14', 'CANCELLED'),
(14, 10, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 13:47:05', 'CANCELLED'),
(15, 11, '2019-11-03', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-03 13:47:12', 'ISSUED'),
(16, 6, '2019-11-14', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-14 15:25:25', 'ISSUED'),
(17, 8, '2019-11-15', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-15 07:30:12', 'ISSUED'),
(18, 9, '2019-11-16', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-16 16:57:18', 'ISSUED'),
(19, 11, '2019-11-16', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-16 17:00:19', 'ISSUED'),
(20, 12, '2019-11-16', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Original copy) on behalf of the School (School Name, City) authority.', 'NO', 'nitin', '2019-11-16 17:10:18', 'ISSUED'),
(21, 8, '2019-11-17', 'I accept all terms &amp; Conditions in issuing this Transfer Certificate as (Duplicate copy) on behalf of the School (School Name, City) authority.', 'good', 'nitin', '2019-11-17 03:34:33', 'ISSUED');
...
--
ALTER TABLE `tc_detail`
  MODIFY `TCID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `tc_issued`
--
ALTER TABLE `tc_issued`
  MODIFY `ISTID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `tc_no`
--
ALTER TABLE `tc_no`
