                            ...
                            ?>">
                                <div class="panel-body">
                                    ...
                                    <div style="float: right; padding: 0px 1px;">
                                        <?php echo anchor('newsevents/delete_news_events/' . $item->ID, '<span style="border: #900000 solid 1px; border-radius:5px;font-size: 11px; color: #ff0000; font-weight: bold; background: #ffffff; padding: 2px">Delete</span>', array('style' => 'float: right')); ?>
                                    </div>
                                    <div style="float: right; padding: 0px 1px;">
                                        <?php echo anchor('newsevents/active_deactive_news/' . $item->ID . '/1', '<span style="border-radius:5px; font-size: 11px; color: #ffffff; background: #909090; padding: 2px">Activate</span>', array('style' => 'float: right')); ?>
                                    </div>
                                    <div style="float: right; padding: 0px 1px;">
                                        <?php echo anchor('newsevents/edit_news_events/' . $item->ID, '<span style="border-radius:5px;font-size: 11px; color: #ffffff; background: #009000; padding: 2px">Edit</span>', array('style' => 'float: right')); ?>
                                    </div>
