                ...
                <?php foreach ($news_ as $item) { ?>
                    <div class="panel panel-default">
                        ...
                        <div id="collapse<?php echo $item->ID; ?>" class="panel-collapse collapse<?php if($loop1 == 1){ echo " in"; } ?>">
                            <div class="panel-body">
                                <?php echo anchor('upcoming/active_deactive_upcoming/'.$item->ID.'/0', '<span style="border-radius: 5px;font-size: 11px; color: #ffffff; background: #904444; padding: 2px">Deactivate</span>', array('style'=>'float: right')); ?>
