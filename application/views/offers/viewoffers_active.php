<div class="col-lg-6">
    <div class="panel panel-default"<?php echo $style_; ?>>
        ...
        <div class="panel-body">
            <?php $cnt_ = count($offers_); ?>
            <?php if ($cnt_ != 0) { ?>
            <div class="panel-group" id="accordion">
                <?php $loop1 = 1; ?>
                <?php foreach ($offers_ as $item) { ?>
                    <div class="panel panel-default">
                        ...
                        <div id="collapse<?php echo $item->ID; ?>" class="panel-collapse collapse<?php if($loop1 == 1){ echo " in"; } ?>">
                            <div class="panel-body">
                                <?php echo anchor('offers/active_deactive_offers/'.$item->ID.'/0', '<span style="border-radius: 5px;font-size: 11px; color: #ffffff; background: #904444; padding: 2px">Deactivate</span>', array('style'=>'float: right')); ?>
