...
<div class="col-lg-12">
    <div class="panel panel-default"<?php //echo $style_; ?>>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-6">
                    <?php echo form_open_multipart('downloads/updateDownloads/'.$dwnldsEditData->DWNLD_ID, array('name' => 'frmDwnlds', 'id' => 'frmDwnlds', 'role' => 'form')); ?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        $data = array(
                            ...
                            'name' => 'txtDesc',
                            'id' => 'txtDesc',
                            'value' => $dwnldsEditData->DESCRIPTION,
                            'style' => 'height: 110px; color: #ff9000'
                        );
                ...
                <div class="col-sm-6">
                    <div class="form-group" style="text-align: right">
                        <button type="submit" id="tc_submit" class="btn btn-danger"> Update </button>
